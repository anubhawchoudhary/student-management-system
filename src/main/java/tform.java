 ...
 * @author acer
 */
public class tform extends javax.swing.JFrame {

    /**
     * Creates new form tform
     */
    public tform() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
